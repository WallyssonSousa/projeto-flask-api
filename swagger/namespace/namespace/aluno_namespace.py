...
from services.AlunoService import get_todos_alunos, get_aluno_por_id, adicionar_aluno, atualizar_aluno, deletar_aluno
...
class AlunoIdResource(Resource):
    ...
    def get(self, id_aluno):
        ...
        return get_aluno_por_id(id_aluno)
