...
class TestStringMethods(unittest.TestCase):
    ...
    def test_002_aluno_por_id(self):
        ...
        #consulta a url /professores/20, pra ver se o aluno está lá
        resposta = requests.get('http://localhost:5000/professores/20')
    ...
    #esse teste adiciona 2 professores, depois deleta 1
    #e verifica que o numero de professores realmente diminuiu
    '''
    ...
    def test_004_deleta(self):
        ...
        requests.post('http://localhost:5000/professores',json={'nome':'marta','id':27})
        ...
        requests.delete('http://localhost:5000/professores/27')
    ...
    #cria professores sem nome, o que tem que dar erro
    ...
    #tenta editar professores sem passar nome, o que também
    ...
    def test_100b_nao_confundir_professor_e_aluno(self):
        ...
        self.assertEqual(len(r_lista_professores.json()),2)
    ...
    def test_109_nao_confundir_professor_e_aluno(self):
        ...
        self.assertEqual(len(r_lista.json()),2)
        r_lista_professores = requests.get('http://localhost:5000/professores')
        self.assertEqual(len(r_lista_professores.json()),0)
